...
class Animation {
  ...
  draw(context) {
    ...
    context.translate(this.destination.posX + this.offsetX, this.destination.posY + this.offsetY);
    ...
    context.translate(-(this.destinationCurrent.width * 0.5), -(this.destinationCurrent.height * 0.5));
