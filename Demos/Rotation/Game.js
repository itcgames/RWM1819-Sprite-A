...
class Game {
  ...
  constructor() {
    ...
    this.cometRotatedAnimator = new AnimationManager();
  ...
  initWorld() {
    ...
    this.img.addEventListener('load', function () {
      ...
      gameInstance.cometAnimator.setRotation("Comet", 2);

      gameInstance.mySpriteRotated = new Animation(gameInstance.img, 266, 162, 50);
      gameInstance.cometRotatedAnimator.addAnimation("Comet", gameInstance.mySpriteRotated);
      gameInstance.cometRotatedAnimator.setRotation("Comet", -20)
      gameNs.game.loop();
    });
  ...
  update() {
    ...
    this.cometRotatedAnimator.update(deltaTime, this.cometRotatedPos.x, this.cometRotatedPos.y);
  }
  ...
  draw() {
    ...
    this.cometRotatedAnimator.draw(this.ctx);
  }
